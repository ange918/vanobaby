...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      style={{ backgroundColor: '#050505', padding: '5rem 2.5rem 2.5rem', textAlign: 'center' }}
    >
      <motion.div
      ...
      >
        ...
        {/* Divider */}
        <div style={{ width: 40, height: 2, backgroundColor: '#C0392B', margin: '0 auto 3rem' }} />
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '2rem' }}>
          <p style={{ color: '#999999', fontSize: '0.75rem', letterSpacing: '0.05em' }}>
